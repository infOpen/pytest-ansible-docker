# -*- coding: utf-8 -*-
#
# pytest-ansible-docker documentation build configuration file, created by
...
project = u'pytest-ansible-docker'
copyright = u'2015, Alexandre Chaussier'
author = u'Alexandre Chaussier'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-ansible-docker Documentation',
     [author], 1)
]
